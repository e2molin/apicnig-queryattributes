...
const mp = new QueryAttributes({
  ...
  configuration: {
    ...
    columns: [
      ...
      { name: 'nivel', alias: 'Vida útil', visible: false, searchable: false, showpanelinfo: true, align: 'left', type: 'percentage' },
      { name: 'urlficha', alias: 'URL PDF Ficha', visible: false, searchable: false, showpanelinfo: true, align: 'left', type: 'linkURL', typeparam:'📝 Acceso datos del vértice' },
      { name: 'urlcdd', alias: 'URL Centro Descargas', visible: false, searchable: false, showpanelinfo: true, align: 'left', type: 'buttonURL', typeparam:'🔗 Acceso CdD' },
