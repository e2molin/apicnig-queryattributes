...
const mp = new QueryAttributes({
  ...
  configuration: {
    ...
    columns: [
      ...
      { name: 'calidad', alias: 'Calidad señal', visible: false, searchable: false, showpanelinfo: true, align: 'left', type: 'formatter', typeparam:'⭐️'},
      { name: 'nivel', alias: 'Vida útil', visible: true, searchable: false, showpanelinfo: true, align: 'left', type: 'percentage' },
      { name: 'urlficha', alias: 'URL PDF Ficha', visible: false, searchable: false, showpanelinfo: true, align: 'left', type: 'linkURL' },
