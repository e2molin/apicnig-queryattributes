...
const mp = new QueryAttributes({
  ...
  configuration: {
    ...
    columns: [
      ...
      { name: 'xutmetrs89', alias: 'Coordenada X (UTM ETRS89)', visible: false, align: 'left', type: 'string', searchable: false },
      { name: 'yutmetrs89', alias: 'Coordenada Y (UTM ETRS89)', visible: false, align: 'left', type: 'string', searchable: false },
      { name: 'lat', alias: 'Latitud', visible: false, align: 'left', type: 'string', searchable: false },
      { name: 'lng', alias: 'Longitud', visible: false, align: 'left', type: 'string', searchable: false },
      { name: 'horto', alias: 'Altitud Ortométrica', visible: false, align: 'left', type: 'string', searchable: false },
      { name: 'calidad', alias: 'Calidad señal', visible: false, align: 'left', type: 'formatter', typeparam:'⭐️', searchable: false },
      { name: 'nivel', alias: 'Vida útil', visible: true, align: 'left', type: 'percentage', searchable: false },
      { name: 'urlficha', alias: 'URL PDF Ficha', visible: false, align: 'left', type: 'linkURL', searchable: false },
      { name: 'urlcdd', alias: 'URL Centro Descargas', visible: true, align: 'left', type: 'buttonURL', typeparam:'🔗 Acceder', searchable: false },
      { name: 'hojamtn50', alias: 'Hoja MTN50', visible: false, align: 'right', type: 'string', searchable: false },
      { name: 'summary', alias: 'Localización', visible: false, align: 'left', type: 'string', searchable: false },
      { name: 'imagemtn50', alias: 'Imagen Hoja MTN50', visible: true, align: 'left', type: 'image', searchable: false },
      { name: 'description', alias: 'Descripción completa', visible: false, align: 'left', type: 'string', searchable: true },
      { name: 'pertenencia', alias: 'Pertenencia', visible: false, align: 'left', type: 'string', searchable: true },
      { name: 'municipio', alias: 'Ayuntamiento', visible: false, align: 'left', type: 'string', searchable: true },
      { name: 'codigoine', alias: 'Municipio', visible: false, align: 'left', type: 'string', searchable: true },
      { name: 'codprov', alias: 'Provincia', visible: false, align: 'left', type: 'string', searchable: false },
      { name: 'codauto', alias: 'Autonomía', visible: false, align: 'left', type: 'string', searchable: false },
    ],
  }
});
