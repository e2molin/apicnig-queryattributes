...
const mp = new QueryAttributes({
  ...
  configuration: {
    ...
    columns: [
      ...
      { name: 'calidad', alias: 'Calidad señal', visible: true, align: 'left', type: 'formatter', typeparam:'⭐️' },
      ...
      { name: 'municipio', alias: 'Ayuntamiento', visible: true, align: 'left', type: 'string' },
